...
as the output window size is small all the contents are not visible'''
from tkinter import*
import random
import os
...
class Bill_App:
    def __init__(self, root):
        self.root = root
        self.root.geometry("8000x600+0+0")  
# Set the window size to 800x600 pixels
    ...
    # ===================Medical====================================
        ...
        F2.place(x=5, y=95, width=325, height=380)
    ...
    # ==========GroceryItems=========================
        ...
        F3.place(x=340, y=95, width=325, height=380)
    ...
    # ===========ColdDrinks================================
        ...
        F4.place(x=670, y=95, width=325, height=380)
    ...
    # =================BillArea======================
        ...
        F5.place(x=1010, y=95, width=350, height=380)
    ...
    # =======================ButtonFrame=============
        ...
        F6.place(x=0, y=480, relwidth=1, height=140)
